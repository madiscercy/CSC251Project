...
public class Policy {
   ...
   public Policy() {
     ...
     public Policy(String policyNum, String provName, String fName, String lName,
                 int holderAge, String holderSmoke, double holderHeight, double holderWeight) {
